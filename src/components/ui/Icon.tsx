import {
  ...
  CheckCircle2, CheckSquare, ChevronDown, ChevronLeft, ChevronRight, ClipboardCheck,
  ...
  Menu, MessageSquare, Minus, Monitor, Paperclip, PenSquare, Phone, PieChart, Plus,
  Puzzle, Receipt, RefreshCw, Rocket, ScanEye, Scale, Search, SearchCheck, Send,
  Settings, Share2, ShieldCheck, ShoppingCart, Smartphone, Sparkles, Star, Store,
  Tag, Target, TrendingUp, Triangle, Twitter, Upload, UserRound, UserSquare, Users,
